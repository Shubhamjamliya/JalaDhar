        ...
        <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-8 xl:gap-10 mb-8 sm:mb-10">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-2.5">
              <li>
                <Link to="/about" className="text-[var(--color-text-secondary)] hover:text-[var(--color-primary)] text-sm transition-colors">
                  About us
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-[var(--color-text-secondary)] hover:text-[var(--color-primary)] text-sm transition-colors">
                  Our services
                </Link>
              </li>
              <li>
                <Link to="/how-it-works" className="text-[var(--color-text-secondary)] hover:text-[var(--color-primary)] text-sm transition-colors">
                  How it works
                </Link>
              </li>
              <li>
              ...
              <li>
                <button 
                  ...
                  className="text-[var(--color-text-secondary)] hover:text-[var(--color-primary)] text-sm transition-colors text-left cursor-pointer"
                >
                  Terms & Conditions
                </button>
              </li>
