                            ...
                            >
                                ...
                                <div className="mt-4 flex items-center justify-end border-t border-gray-100 pt-3">
                                    <label className="switch-container relative inline-flex cursor-pointer items-center">
                                        ...
                                        />
                                        <div
                                            className={`slider peer h-6 w-10 rounded-full after:absolute after:top-[4px] after:left-[4px] after:h-4 after:w-4 after:rounded-full after:border after:border-gray-300 after:bg-white after:content-[''] peer-focus:outline-none transition-all ${service.isActive
