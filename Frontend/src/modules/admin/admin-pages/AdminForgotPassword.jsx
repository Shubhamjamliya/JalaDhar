...
export default function AdminForgotPassword() {
    ...
    const handleSendOTP = async (e) => {
        ...
        try {
            const response = await adminForgotPassword({ email: identifier.trim() });
    ...
    const handleVerifyOTP = async (e) => {
        ...
        toast.showSuccess("OTP verified! Set your new admin password.");
                    ...
                    {step === 1 ? (
                        ...
                        <form onSubmit={handleSendOTP} className="space-y-4">
                            <p className="text-slate-600 text-sm mb-4 text-center leading-relaxed">
                                Enter your admin mobile number or email address to receive a password reset OTP.
                            </p>
