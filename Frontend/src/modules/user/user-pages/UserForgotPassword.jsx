...
export default function UserForgotPassword() {
    ...
    const handleSendOTP = async (e) => {
        ...
        try {
            const response = await forgotPassword({ email: identifier.trim() });
                    ...
                    {step === 1 ? (
                        ...
                        <form onSubmit={handleSendOTP} className="space-y-4">
                            <p className="text-slate-600 text-sm mb-4 text-center leading-relaxed">
                                Enter your registered mobile number or email address and we'll send you an OTP to verify your account.
                            </p>
