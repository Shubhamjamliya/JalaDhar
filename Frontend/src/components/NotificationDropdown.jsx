...
const TYPE_META = {
  ...
  BOOKING_EN_ROUTE:           { icon: IoCalendarOutline,        color: 'text-indigo-600 bg-indigo-50' },
  ...
  BOOKING_REASSIGNED_AWAY:    { icon: IoCalendarOutline,        color: 'text-gray-600 bg-gray-50' },
  BOOKING_UPDATE:             { icon: IoCalendarOutline,        color: 'text-blue-600 bg-blue-50' },
  ...
  PAYMENT_RELEASED:           { icon: IoCashOutline,            color: 'text-emerald-600 bg-emerald-50' },
  ...
  WITHDRAWAL_REQUEST:         { icon: IoWalletOutline,          color: 'text-blue-600 bg-blue-50' },
  WITHDRAWAL_PROCESSED:       { icon: IoCashOutline,            color: 'text-emerald-600 bg-emerald-50' },
  PLATFORM_FEE_DEDUCTION:     { icon: IoCashOutline,            color: 'text-purple-600 bg-purple-50' },
  ...
  DISPUTE_CREATED:            { icon: IoAlertCircleOutline,     color: 'text-red-600 bg-red-50' },
